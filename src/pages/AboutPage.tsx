...
export default function AboutPage({ onNavigate }: AboutPageProps) {
  const [mainTeachers, setMainTeachers] = useState<TeacherRecord[]>(featuredFallbackTeachers)
      ...
      <section className="py-20 px-6 text-center relative">
        ...
        <div className="relative max-w-4xl mx-auto">
          ...
          <p className="text-muted-foreground text-lg leading-relaxed max-w-2xl mx-auto font-golos">
            Уникальный образовательный проект, объединяющий Академию актёрского мастерства, Школу юного актёра и мастер-курсы с ведущими представителями киноиндустрии.
          </p>
        </div>
      </section>
      ...
      <section className="py-20 px-6">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
            {values.map((v, i) => (
              <div key={i} className="card-glass rounded-2xl card-glow p-6 transition-all duration-500 group text-center">
            ...
            {mainTeachers.map((t) => (
              ...
              >
                <div className="flex items-center gap-4 mb-4">
                  <TeacherAvatar teacher={t} className="w-14 h-14 flex-shrink-0 group-hover:border-gold/60 transition-all duration-300" />
                  <h3 className="font-playfair text-base font-semibold text-foreground leading-tight">{t.name}</h3>
                </div>
                <p className="font-golos text-xs text-gold mb-1">{t.short_role || t.role}</p>
        ...
        <div className="max-w-3xl mx-auto text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
            <div className="border border-gold/15 p-6 text-center rounded-2xl">
              ...
              <div className="font-golos text-sm text-foreground">Москва, Страстной бульвар, 4</div>
            </div>
            <div className="border border-gold/15 p-6 text-center rounded-2xl">
              ...
              <div className="font-golos text-sm text-foreground">+7 (999) 000-00-00</div>
            </div>
            <div className="border border-gold/15 p-6 text-center rounded-2xl">
              <Icon name="Clock3" size={20} className="text-gold mx-auto mb-3" />
              <div className="text-xs tracking-widest uppercase text-muted-foreground font-golos mb-2">График</div>
              <div className="font-golos text-sm text-foreground">ежедневно, 10:00–22:00</div>
            </div>
          </div>
        </div>
      </section>
